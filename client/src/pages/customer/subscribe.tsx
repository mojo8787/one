...
export default function Subscribe() {
  ...
  useEffect(() => {
    // Get or create subscription as soon as the page loads
  ...
  return (
    <div className="max-w-md mx-auto p-6 bg-white rounded-lg shadow-md mt-12">
      <h2 className="text-2xl font-bold text-gray-800 mb-6">Start Your PureFlow Subscription</h2>
      <p className="text-gray-600 mb-6">Your first month's payment will be processed now, and your subscription will renew automatically each month.</p>
